...
$api->route('/users/csv/', 'GET', require 'inc/routes/users-csv.php');
$api->route('/users/xlsx/', 'GET', require 'inc/routes/users-xlsx.php');
...
$api->route('/test/', 'GET', require 'inc/routes/test-form.php');
